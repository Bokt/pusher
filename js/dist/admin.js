...
/***/ "./src/admin/components/PusherSettingsModal.js":
/*!*****************************************************!*\
  !*** ./src/admin/components/PusherSettingsModal.js ***!
  \*****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return PusherSettingsModal; });
...
var PusherSettingsModal =
/*#__PURE__*/
function (_SettingsModal) {
  Object(_babel_runtime_helpers_esm_inheritsLoose__WEBPACK_IMPORTED_MODULE_0__["default"])(PusherSettingsModal, _SettingsModal);

  function PusherSettingsModal() {
    return _SettingsModal.apply(this, arguments) || this;
  }

  var _proto = PusherSettingsModal.prototype;
...
/* harmony import */ var _components_PusherSettingsModal__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/PusherSettingsModal */ "./src/admin/components/PusherSettingsModal.js");



flarum_app__WEBPACK_IMPORTED_MODULE_1___default.a.initializers.add('flarum-pusher', function (app) {
  app.extensionSettings['flarum-pusher'] = function () {
    return app.modal.show(new _components_PusherSettingsModal__WEBPACK_IMPORTED_MODULE_2__["default"]());
  };
});
